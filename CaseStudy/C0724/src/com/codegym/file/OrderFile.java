...
public class OrderDetailFile {
        public static void saveToFile(List<OrderDetail> orderDetailList) {
            if (!orderDetailList.isEmpty()) {
                try{
                    String fileName = "/Users/phamlong/CODEGYM/module-2/CaseStudy/C0724/src/com/codegym/file/txt/order_detail_file.txt";
                    FileWriter fileWriter = new FileWriter(fileName);
                    for (O product : productList) {
